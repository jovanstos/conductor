...
export default function WorkspaceBar() {
  ...
  return (
    <div
      className={`flex items-center gap-2.5 px-4 py-2 border-b text-sm transition-colors cursor-pointer select-none group
        ${workspacePath
    ...
    >
      {workspacePath ? (
        ...
        <FolderX size={15} className="text-amber-400 shrink-0" />
      )}

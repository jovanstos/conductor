      ...
      <button
        ...
        onMouseEnter={e => {
          if (!e.currentTarget.disabled) {
            e.currentTarget.style.color = 'rgb(216,180,254)'
...
function ToolbarBtn({
  ...
  const colors: Record<typeof color, string> = {
    purple:  "border-purple-500/30 hover:border-purple-500/50 text-purple-400/70 hover:text-purple-300",
    amber:   "border-amber-500/30 hover:border-amber-500/50 text-amber-400/70 hover:text-amber-300",
    blue:    "border-blue-500/30 hover:border-blue-500/50 text-blue-400/70 hover:text-blue-300",
    emerald: "border-emerald-500/30 hover:border-emerald-500/50 text-emerald-400/70 hover:text-emerald-300",
    indigo:  "border-indigo-500/30 hover:border-indigo-500/50 text-indigo-400/70 hover:text-indigo-300",
    gray:    "hover:text-[var(--c-text-2)]",
  };
  return (
    <button
      onClick={onClick}
